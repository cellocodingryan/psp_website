...
<?php
$user_location = "gallery";
include_once 'nav.php';
?>
<h1 class="loading">Generating your pictures</h1>
<div class="myslide hide">
    <!-- Jssor Slider Begin -->

    <img class="gallery_image" src="images/Gallery.png">

    <div id="slider1_container" style="visibility: hidden; position: relative; width: 2880px; height: 1920px;">
        <!-- Loading Screen -->


        <!-- Slides Container -->
        <div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 2880px; height: 1920px;
            overflow: hidden;">
            <?php
            $dir = "pictures";
            $files = scandir($dir);
            for ($i = 2;$i < sizeof($files);$i += 1) {
                ...
                $file =  '<div><img data-u="image" src="pictures/' . $files[$i] . '"></div>';
                echo $file;
            }
